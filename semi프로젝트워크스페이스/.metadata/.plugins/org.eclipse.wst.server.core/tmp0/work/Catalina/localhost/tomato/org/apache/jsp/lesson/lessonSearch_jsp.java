 ...
 * Generated at: 2021-10-19 09:30:44 UTC
...
public final class lessonSearch_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if(m_id==null){
   ...
   if(m_id.equals("admin")){
      ...
      out.write("</li><!-- 마감일 -->\r\n");
      out.write("               <li class=\"l_name\"><label>레슨명</label>\r\n");
      out.write("               &nbsp;&nbsp;&nbsp;");
...
if(arr.get(i).getL_lessonok()==1){
      ...
      out.write("\r\n");
      out.write("               </li><br>\r\n");
      out.write("               <li class=\"l_name\"><label>작성자</label>\r\n");
      out.write("               &nbsp;&nbsp;&nbsp;");
      out.print(arr.get(i).getM_name());
      out.write('(');
      out.print(arr.get(i).getM_id() );
      out.write(")</li><br><!-- 작성자 문제 -->\r\n");
      out.write("               <li class=\"l_title\"><label>클래스소개</label>\r\n");
      out.write("               &nbsp;&nbsp;&nbsp;");
      out.print(arr.get(i).getL_con().length()>=10?
               arr.get(i).getL_con().substring(0, 10)+"...":arr.get(i).getL_con() );
      out.write("</li><br><br>\r\n");
      out.write("               <li class=\"l_bar\"><label>모집인원</label>\r\n");
      out.write("               ");
