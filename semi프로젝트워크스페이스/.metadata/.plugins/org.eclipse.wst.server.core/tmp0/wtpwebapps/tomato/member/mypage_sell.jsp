...
<div class="table-title">
            ...
            <tfoot>
				<tr>
					...
					if(userGroup!=0){
						%>
						<a href="mypage_sell.jsp?cp=1&m_idx=<%=m_idx%>">%lt;&lt;</a>
						<a href="mypage_sell.jsp?cp=<%=(userGroup-1)*pageSize+pageSize %>&m_idx=<%=m_idx%>">&lt;</a>
						<%
					}
					%>
					<%
					for(int i=userGroup*pageSize+1;i<userGroup*pageSize+pageSize;i++){
						...
						&nbsp;&nbsp;<a href="mypage_sell.jsp?cp=<%=i %>&m_idx=<%=m_idx%>"><%=i %>
						</a>&nbsp;&nbsp;</label>
						<%
						if(i==totalPage){
							break;
					...
					if(userGroup!=(totalPage/pageSize)-(totalPage%pageSize==0?1:0)){
						%>
						<a href="mypage_sell.jsp?cp=<%=(userGroup+1)*pageSize+1 %>&m_idx=<%=m_idx%>">&gt;</a>
						<a href="mypage_sell.jsp?cp=<%=totalPage %>&m_idx=<%=m_idx%>">&gt;&gt;</a>
						<%
					}
					%>
					</td>
