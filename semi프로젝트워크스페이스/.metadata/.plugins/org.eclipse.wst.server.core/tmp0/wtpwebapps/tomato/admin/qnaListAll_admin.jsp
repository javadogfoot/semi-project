        ...
        <table class="table table-striped table-hover" style="margin-left:200px; margin-top:25px;">
         ...
         <tfoot>
            <tr>
               ...
               if(userGroup!=0){
                  %>
                  <a href="qnaListAll_admin.jsp?cp=<%=(userGroup-1)*pageSize+pageSize%>">&lt;&lt;</a>
                  <%
               }
               %>
               <%
               for(int i=userGroup*pageSize+1;i<=userGroup*pageSize+pageSize;i++){
                  %>&nbsp;&nbsp;&nbsp;<a href="qnaListAll_admin.jsp?cp=<%=i%>"><%=i%></a>&nbsp;&nbsp;&nbsp;<%
                  if(i==totalPage){
                     break;
                  }
               }
               ...
               if(userGroup!=(totalPage/pageSize)-(totalPage%pageSize==0?1:0)){
                  %>
                  <a href="qnaListAll_admin.jsp?cp=<%=(userGroup+1)*pageSize+1%>">&gt;&gt;</a>
                  <%
               }
               %>
               </td>
            ...
            if(arr==null||arr.size()==0){
               ...
               for(int i=0;i<arr.size();i++){
                  ...
                  <tr>
                    ...
                    <td><a href="/tomato/qna/qnaContent.jsp?q_idx=<%=arr.get(i).getQ_idx() %>"><%=arr.get(i).getQ_sub().substring(0,5) %>...</a></td>             
